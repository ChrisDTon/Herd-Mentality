...
const AnswerCard = () => {
  return (
    <div className='relative card w-fit h-fit max-w-[18.9vw] bg-accent text-accent-content shadow-xl'>
        ...
        <p className='card-body text-center text-4xl break-words overflow-auto max-h-[40vh]'>Super duper long text to increase the width and size of the card for testing purposes and to be a bit annoying pneumonoultramicroscopicsilicovolcanoconiosis</p>
        <ModifierButtons />
    </div>
  )
}
